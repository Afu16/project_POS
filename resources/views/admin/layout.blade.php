        ...
        <div class="flex-1 overflow-y-auto py-4">
            <nav>
                <ul class="space-y-2 px-4">
                    <li>
                        <a href="{{ url('admin/barangs') }}" class="sidebar-link flex items-center space-x-3 p-3 rounded-lg">
                            <i class="fas fa-box-open w-5 text-center"></i>
                            <span>Produk</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('admin/jenis_barangs') }}" class="sidebar-link flex items-center space-x-3 p-3 rounded-lg">
                            <i class="fas fa-tags w-5 text-center"></i>
                            <span>Jenis Barang</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('admin/transaksis') }}" class="sidebar-link flex items-center space-x-3 p-3 rounded-lg">
    ...
    <div class="flex-1 overflow-y-auto p-6">
        <div class="max-w-2xl mx-auto">
            ...
            <p class="text-gray-700">
                Gunakan menu navigasi di samping untuk mengakses fitur-fitur sistem kasir. Aplikasi ini mendukung transaksi penjualan, manajemen produk, dan laporan lengkap untuk bisnis Anda.
            </p>
        </div>
    </div>
